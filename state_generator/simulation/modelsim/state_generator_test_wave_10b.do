...
add wave -noupdate /state_generator/FP_CMD
add wave -noupdate /state_generator/step
add wave -noupdate /state_generator/IR
add wave -noupdate /state_generator/not_reset
add wave -noupdate /state_generator/clk
add wave -noupdate /state_generator/irq
...
WaveRestoreCursors {{Cursor 1} {1437526 ps} 0}
...
wave create -driver freeze -pattern constant -value 0 -starttime 0ns -endtime 8000ns sim:/state_generator/FP_CMD 
wave create -driver freeze -pattern constant -value 1 -starttime 0ns -endtime 8000ns sim:/state_generator/step 
wave modify -driver freeze -pattern clock -initialvalue 0 -period 200ns -dutycycle 50 -starttime 200ns -endtime 400ns Edit:/state_generator/clk 
wave modify -driver freeze -pattern constant -value 0 -starttime 0ns -endtime 8000ns Edit:/state_generator/HLT 
wave modify -driver freeze -pattern constant -value 0 -starttime 0ns -endtime 8000ns Edit:/state_generator/step 
wave modify -driver freeze -pattern constant -value 1 -starttime 2200ns -endtime 8000ns Edit:/state_generator/HLT 
wave modify -driver freeze -pattern constant -value 0 -starttime 3200ns -endtime 8000ns Edit:/state_generator/HLT 
wave modify -driver freeze -pattern constant -value 1 -starttime 4200ns -endtime 4400ns Edit:/state_generator/start 
wave modify -driver freeze -pattern constant -value 0 -starttime 6000ns -endtime 8000ns Edit:/state_generator/start 
wave modify -driver freeze -pattern constant -value 1 -starttime 0ns -endtime 8000ns Edit:/state_generator/FP_CMD 
wave modify -driver freeze -pattern constant -value 0 -starttime 0ns -endtime 6000ns Edit:/state_generator/start 
wave modify -driver freeze -pattern constant -value 0 -starttime 0ns -endtime 8000ns Edit:/state_generator/HLT 
wave modify -driver freeze -pattern constant -value 1 -starttime 1400ns -endtime 1600ns Edit:/state_generator/start 
wave modify -driver freeze -pattern constant -value 0 -starttime 1400ns -endtime 8000ns Edit:/state_generator/FP_CMD 
WaveCollapseAll -1
