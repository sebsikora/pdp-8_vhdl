...
architecture rtl of decoder_3_to_8 is
	...
	begin
		...
		and_3_6:					AND_3_gate port map (inputA => not_input(0), inputB => input(1), inputC => input(2), output => output(6));
		and_3_7:					AND_3_gate port map (inputA => input(0), inputB => input(1), inputC => input(2), output => output(7));
end rtl;