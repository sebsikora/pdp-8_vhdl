...
architecture rtl of tty_output_state_gen is
	...
	begin
		...
		ms_jk_ff_0:							ms_jk_ff port map ( j => SEND, k => or_4_output, clk => and_10_output, not_reset => not_reset, q => ms_jk_ff_0_q, not_q => ms_jk_ff_0_not_q);
		...
		and_12:								AND_gate port map (inputA => not_reset, inputB => SLOW_clk, output => and_12_output);
		ms_jk_ff_2:							ms_jk_ff port map ( j => ms_jk_ff_0_q, k => or_4_output, clk => and_12_output, not_reset => not_reset, q => ms_jk_ff_2_q, not_q => ms_jk_ff_2_not_q);
