...
ENTITY 	tty_state_gen IS
	...
	SLOW_clk_not_clear : OUT std_logic;
...
-- SLOW_clk_RUN	=>  Location: PIN_27,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- SLOW_clk_not_clear	=>  Location: PIN_26,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- ser_data_in	=>  Location: PIN_18,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- clk	=>  Location: PIN_21,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- not_reset	=>  Location: PIN_22,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- SEND	=>  Location: PIN_32,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- CLR_TX_FLAG	=>  Location: PIN_28,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
SIGNAL ww_SLOW_clk_not_clear : std_logic;
...
SLOW_clk_not_clear <= ww_SLOW_clk_not_clear;
...
-- Equation(s):
-- \ms_jk_ff_0|nand_3_3|output~1_combout\ = (\ms_jk_ff_0|nand_5|output~2_combout\) # ((\tty_output_counter|ms_jk_ff_1|nand_5|output~1_combout\) # (\tty_output_counter|ms_jk_ff_3|nand_5|output~1_combout\))
...
PORT MAP (
	...
	datab => \tty_output_counter|ms_jk_ff_3|nand_1|output~2_combout\,
	datac => \not_reset~combout\,
...
-- Equation(s):
-- \tty_output_counter|ms_jk_ff_2|nand_3_1|output~1_combout\ = (\SLOW_clk~combout\ & (!\tty_output_counter|ms_jk_ff_0|nand_5|output~1_combout\ & (!\ms_jk_ff_2|nand_5|output~1_combout\ & !\tty_output_counter|ms_jk_ff_1|nand_5|output~1_combout\)))
...
-- Equation(s):
-- \tty_output_counter|ms_jk_ff_3|nand_1|output~2_combout\ = (!\tty_output_counter|ms_jk_ff_3|nand_1|output~1_combout\ & (((\tty_output_counter|ms_jk_ff_2|nand_5|output~1_combout\) # (!\tty_output_counter|ms_jk_ff_2|nand_3_1|output~1_combout\)) # 
...
PORT MAP (
	...
	datac => \tty_output_counter|ms_jk_ff_2|nand_3_1|output~1_combout\,
...
-- Equation(s):
-- \ms_jk_ff_1|nand_3_3|output~1_combout\ = (\or_3|output~2_combout\ & ((\ms_jk_ff_1|nand_3_3|output~2_combout\ & ((\ms_jk_ff_1|nand_6|output~1_combout\))) # (!\ms_jk_ff_1|nand_3_3|output~2_combout\ & (\CLR_TX_FLAG~combout\ & 
-- !\ms_jk_ff_1|nand_6|output~1_combout\))))
...
-- Equation(s):
-- \and_3|output~0_combout\ = (\SLOW_clk~combout\ & !\ms_jk_ff_2|nand_5|output~1_combout\)
...
-- Equation(s):
-- \or_2|output~combout\ = (\ms_jk_ff_0|nand_6|output~2_combout\ & (!\ms_jk_ff_0|nand_5|output~2_combout\ & ((\and_3|output~0_combout\)))) # (!\ms_jk_ff_0|nand_6|output~2_combout\ & ((\clk~combout\) # ((!\ms_jk_ff_0|nand_5|output~2_combout\ & 
-- \and_3|output~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \ms_jk_ff_0|nand_6|output~2_combout\,
	datab => \ms_jk_ff_0|nand_5|output~2_combout\,
	datac => \clk~combout\,
	datad => \and_3|output~0_combout\,
...
-- Equation(s):
-- \ms_jk_ff_0|nand_1|output~1_combout\ = (\or_2|output~combout\ & (!\ms_jk_ff_0|nand_3_1|output~0_combout\ & ((!\ms_jk_ff_0|nand_3_3|output~0_combout\) # (!\ms_jk_ff_0|nand_3_3|output~1_combout\)))) # (!\or_2|output~combout\ & 
...
PORT MAP (
	...
	datab => \ms_jk_ff_0|nand_3_1|output~0_combout\,
	datac => \ms_jk_ff_0|nand_3_3|output~0_combout\,
...
-- Equation(s):
-- \ms_jk_ff_0|nand_3_3|output~0_combout\ = (\not_reset~combout\ & !\ms_jk_ff_0|nand_1|output~1_combout\)
...
-- Equation(s):
-- \ms_jk_ff_0|nand_5|output~1_combout\ = (!\clk~combout\ & !\ms_jk_ff_0|nand_1|output~1_combout\)
...
-- Equation(s):
-- \tty_output_counter|ms_jk_ff_2|nand_3_1|output~0_combout\ = (!\tty_output_counter|ms_jk_ff_1|nand_5|output~1_combout\ & (\SLOW_clk~combout\ & !\ms_jk_ff_2|nand_5|output~1_combout\))
...
PORT MAP (
	...
	datad => \tty_output_counter|ms_jk_ff_0|nand_1|output~1_combout\,
...
-- Equation(s):
-- \tty_output_counter|ms_jk_ff_0|nand_5|output~1_combout\ = (\ms_jk_ff_2|nand_5|output~1_combout\ & (((\tty_output_counter|ms_jk_ff_0|nand_1|output~2_combout\)))) # (!\ms_jk_ff_2|nand_5|output~1_combout\ & ((\SLOW_clk~combout\ & 
...
-- Equation(s):
-- \tty_output_counter|ms_jk_ff_1|nand_3_3|output~2_combout\ = ((\tty_output_counter|ms_jk_ff_0|nand_5|output~1_combout\ & ((\tty_output_counter|ms_jk_ff_3|nand_5|output~1_combout\) # (\tty_output_counter|ms_jk_ff_1|nand_5|output~1_combout\)))) # 
...
PORT MAP (
	...
	datac => \tty_output_counter|ms_jk_ff_2|nand_3_1|output~0_combout\,
...
-- Equation(s):
-- \tty_output_counter|ms_jk_ff_1|nand_1|output~1_combout\ = (\SLOW_clk~combout\ & (!\ms_jk_ff_2|nand_5|output~1_combout\ & (\tty_output_counter|ms_jk_ff_1|nand_5|output~1_combout\ & !\tty_output_counter|ms_jk_ff_0|nand_5|output~1_combout\)))
...
PORT MAP (
	...
	datac => \tty_output_counter|ms_jk_ff_1|nand_3_3|output~2_combout\,
...
PORT MAP (
	dataa => \tty_output_counter|ms_jk_ff_1|nand_5|output~1_combout\,
	datab => \ms_jk_ff_2|nand_5|output~1_combout\,
	datac => \tty_output_counter|ms_jk_ff_1|nand_1|output~2_combout\,
	datad => \SLOW_clk~combout\,
...
-- Equation(s):
-- \and_2|output~combout\ = (\tty_output_counter|ms_jk_ff_3|nand_5|output~1_combout\) # (\tty_output_counter|ms_jk_ff_1|nand_5|output~1_combout\)
...
-- Equation(s):
-- \tty_output_counter|ms_jk_ff_2|nand_3_3|output~0_combout\ = (\tty_output_counter|ms_jk_ff_2|nand_5|output~1_combout\) # (((\tty_output_counter|ms_jk_ff_3|nand_5|output~1_combout\ & \tty_output_counter|ms_jk_ff_0|nand_5|output~1_combout\)) # 
-- (!\tty_output_counter|ms_jk_ff_2|nand_3_1|output~0_combout\))
...
PORT MAP (
	dataa => \tty_output_counter|ms_jk_ff_3|nand_5|output~1_combout\,
	datab => \tty_output_counter|ms_jk_ff_2|nand_5|output~1_combout\,
	datac => \tty_output_counter|ms_jk_ff_2|nand_3_1|output~0_combout\,
	datad => \tty_output_counter|ms_jk_ff_0|nand_5|output~1_combout\,
...
-- Equation(s):
-- \tty_output_counter|ms_jk_ff_2|nand_3_1|output~2_combout\ = (\and_2|output~combout\ & (\tty_output_counter|ms_jk_ff_2|nand_5|output~1_combout\ & (\tty_output_counter|ms_jk_ff_2|nand_3_1|output~0_combout\ & 
...
-- Equation(s):
-- \tty_output_counter|ms_jk_ff_2|nand_1|output~1_combout\ = (!\tty_output_counter|ms_jk_ff_2|nand_3_1|output~2_combout\ & ((\tty_output_counter|ms_jk_ff_2|nand_1|output~1_combout\) # ((!\tty_output_counter|ms_jk_ff_2|nand_3_3|output~0_combout\) # 
-- (!\not_reset~combout\))))
...
-- Equation(s):
-- \tty_output_counter|ms_jk_ff_2|nand_5|output~1_combout\ = (\SLOW_clk~combout\ & ((\ms_jk_ff_2|nand_5|output~1_combout\ & ((\tty_output_counter|ms_jk_ff_2|nand_1|output~1_combout\))) # (!\ms_jk_ff_2|nand_5|output~1_combout\ & 
...
-- Equation(s):
-- \nor_0|output~0_combout\ = (((!\tty_output_counter|ms_jk_ff_0|nand_5|output~1_combout\) # (!\tty_output_counter|ms_jk_ff_1|nand_5|output~1_combout\)) # (!\tty_output_counter|ms_jk_ff_2|nand_5|output~1_combout\)) # 
-- (!\tty_output_counter|ms_jk_ff_3|nand_5|output~1_combout\)
...
-- Equation(s):
-- \ms_jk_ff_1|nand_3_3|output~2_combout\ = (\not_reset~combout\ & ((\ms_jk_ff_1|nand_3_3|output~1_combout\ & ((\and_2|output~combout\) # (!\ms_jk_ff_1|nand_3_3|output~2_combout\))) # (!\ms_jk_ff_1|nand_3_3|output~1_combout\ & 
-- (\ms_jk_ff_1|nand_3_3|output~2_combout\))))
...
PORT MAP (
	...
	datab => \ms_jk_ff_1|nand_3_3|output~2_combout\,
	datac => \not_reset~combout\,
	datad => \and_2|output~combout\,
...
\SLOW_clk_not_clear~I\ : cycloneii_io
-- pragma translate_off
GENERIC MAP (
	input_async_reset => "none",
	input_power_up => "low",
