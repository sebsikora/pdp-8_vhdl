...
add wave -noupdate /tty_state_gen/SLOW_clk_RUN
add wave -noupdate /tty_state_gen/SLOW_clk_not_clear
...
wave modify -driver freeze -pattern constant -value 0 -starttime 200ns -endtime 10000ns Edit:/tty_state_gen/SLOW_clk 
wave modify -driver freeze -pattern clock -initialvalue 1 -period 600ns -dutycycle 50 -starttime 800ns -endtime 10000ns Edit:/tty_state_gen/SLOW_clk 
wave modify -driver freeze -pattern constant -value 0 -starttime 5000ns -endtime 5200ns Edit:/tty_state_gen/CLR_TX_FLAG 
wave modify -driver freeze -pattern constant -value 0 -starttime 5400ns -endtime 5600ns Edit:/tty_state_gen/SEND 
wave modify -driver freeze -pattern clock -initialvalue 1 -period 730ns -dutycycle 50 -starttime 800ns -endtime 10000ns Edit:/tty_state_gen/SLOW_clk 
WaveCollapseAll -1
